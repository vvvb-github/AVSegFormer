...
from .base.multimodel_uniperceiver import MultiModelBertEncoder
from .adapter_modules import SpatialPriorModule, InteractionBlock, deform_inputs


class UniPerceiverAdapter(MultiModelBertEncoder):
    def __init__(self, pretrain_size=224, num_heads=12, conv_inplane=64, n_points=4,
                 ...
                 with_cp=False, out_indices=(0, 1, 2, 3), *args, **kwargs):
    ...
    def forward(self, x, q):
        ...
        for i, layer in enumerate(self.interactions):
            ...
            x, c, q = layer(x, c, q, None, self.layers[indexes[0]:indexes[-1] + 1],
